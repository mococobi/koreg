...
<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/_custom/javascript/KeyTable-2.11.0/js/dataTables.keyTable.min.js?v=20231006001"></script>
