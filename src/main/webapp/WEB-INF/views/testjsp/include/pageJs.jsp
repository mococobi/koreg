<%@ page language="java" contentType="thtml; charset=UTF-8"
	pageEncoding="UTF-8"%><!-- Jquery Js file -->
...
<script type="text/javascript" charset="UTF-8"
	src="${pageContext.request.contextPath}/plugins/main/javascript/common.js?v=2020032501"></script>
<script type="text/javascript" charset="UTF-8"
