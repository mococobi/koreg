    ...
    mstrmojo.plugins.OffLineMap.OffLineMap = mstrmojo.declare(
        ...
        null,
        {
			...
			if (container.empty()) {
			 ...
			 var mymap = L.map(divId).setView(centerLatLng, zoomLevel);  
			 // 조회 가능한 최대 범위 지정  
			 // "122.03613281250001,31.85889704445453,132.13256835937503,39.436192999314095" 
		/* 	 mymap.setMaxBounds ([
				 [31.8, 122.03 ], 
				 [39.43 , 132.132]
			 ]) */
			...
			var tileLayer = L.tileLayer(
				 'http://localhost:9090/Map/Tiles/{z}/{x}/{y}.png', 
				{
				maxZoom: 15, minZoom:2, 
				errorTileUrl : "http://localhost:9090/Map/Tiles/errorTile.png" , 
 ...
 */				labelData =  data   ; 
		...
		function drawGeoJsonMap() {
				...
				var geoJsonFilePath  ="http://localhost:9090/MicroStrategy/plugins/OffLineMap/lib/" +  geoJsonFile ;  
